...
function convert(input, options) {
    ...
    return unzip.openZip(input)
        ...
        .then(function(docxFile) {
            const handleDocumentResult = docxReader.read(docxFile, input)
            .then(function(documentResult) {
                const returnObject = documentResult.map(options.transformDocument);
                return Object.assign({}, {result: returnObject}, {styles: documentResult.styles});
            })
            .then(function(documentResult) {
                const returnResult =  Object.assign({}, convertDocumentToHtml(documentResult.result, options), {styles: documentResult.styles});
                return returnResult;
            });
            console.log(handleDocumentResult);
            return handleDocumentResult
          });
}
