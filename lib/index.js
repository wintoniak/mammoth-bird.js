...
function convertDocumentToHtml(documentResult, options) {
    ...
    const documentResultReturn = documentResult.flatMapThen(function(document) {
      ...
      return {
          value: documentResult.value,
          customStyles: documentResult.customStyles
      };
    })

    console.log('DR',documentResultReturn);
    return documentResultReturn;
}
