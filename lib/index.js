...
function convertToHtml(input, options) {
    return convert(input, options).then(function(result) {
      // Store customStyles in mammoth after conversion
      exports.presetStyles = options.customStyles;
      console.log('mammoth.presetStyles: ', exports.presetStyles);
      return result;
  });
}

function getPresetStyles() {
    console.log('mammoth.presetStyles e: ', exports.presetStyles);
