...
function extractStyleProperties(styleElement, styles, isRecursive = false) {
    var properties = {};
    ...
    if (basedOnElement) {
        ...
        if (baseStyle && baseStyle.element) {
            ...
            var baseProperties = extractStyleProperties(baseStyle.element, styles, true);
    ...
    console.log(numberingProperties, isRecursive);
    if (numberingProperties && numberingProperties.length) {
