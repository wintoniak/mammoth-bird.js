...
function extractStyleProperties(styleElement, styles) {
  ...
  if (rPr) {
    ...
    properties.bold = boldElement && boldElement.attributes["w:val"] && boldElement.attributes["w:val"] !== "false" ? true : undefined;
  ...
  console.log(cleanedProperties, styleElement.attributes["w:styleId"]);
