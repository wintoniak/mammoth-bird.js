...
var readNumberingProperties = require("./body-reader").readNumberingProperties;
var readSpacingProperties = require("./body-reader").readSpacingProperties;
