...
function read(docxFile, input) {
    ...
    return promises.props({
        ...
        return readXmlFileWithBody(result.partPaths.mainDocument, result, function(bodyReader, xml) {
            ...
            // Append the custom styles to the final result
            const customStyles = result.styles.getCustomStyles(); // Get the custom styles
            return Object.assign(finalDocument, { customStyles: customStyles });
        });
    });
}
