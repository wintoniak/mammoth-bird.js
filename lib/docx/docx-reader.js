...
function read(docxFile, input) {
    ...
    return promises.props({
        ...
        // Ensure styles are added to the result object
        ...
        return promises.props({
            ...
            result.footnotes = notesResult.footnotes;
            result.endnotes = notesResult.endnotes;
            result.comments = notesResult.comments;
            result.notes = new documents.Notes([...notesResult.footnotes, ...notesResult.endnotes]);
            return result;
        });
    }).then(function(result) {
        return readXmlFileWithBody(result.partPaths.mainDocument, result, function(bodyReader, xml) {
            ...
            // Pass styles in the final result
