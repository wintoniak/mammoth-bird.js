...
function read(docxFile, input) {
    ...
    return promises.props({
      ...
      const readResult = readXmlFileWithBody(result.partPaths.mainDocument, result, function(bodyReader, xml) {
    ...
    console.log("styleResult", result.styles);
        return Object.assign(readResult, {styles: result.styles});
    });
}
