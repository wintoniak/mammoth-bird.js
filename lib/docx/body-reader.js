...
function BodyReader(options) {
    ...
    function parseImageProperties(element) {
        ...
        var alignment = { horizontal: null, vertical: null };
        var positionOffset = { horizontal: null, vertical: null };
        ...
        if (element.name === "wp:inline") {
            ...
            var wrapElement = element.children.find((child) =>
        ...
        // Detect alignment
        var positionH = element.children.find((child) => child.name === "wp:positionH");
        var positionV = element.children.find((child) => child.name === "wp:positionV");
    
        if (positionH) {
            alignment.horizontal = positionH.attributes.relativeFrom;
            var posOffsetH = positionH.children.find((child) => child.name === "wp:posOffset");
        ...
        if (positionV) {
            ...
            var posOffsetV = positionV.children.find((child) => child.name === "wp:posOffset");
    ...
    function readBlip(element, blip) {
      ...
      var formatOptions = parseImageProperties(element);

      if (blipImageFile === null) {
          return emptyResultWithMessages([warning("Could not find image file for a:blip element")]);
      } else {
          return readImage(blipImageFile, altText, width, height, formatOptions.floating, formatOptions.wrappingStyle, formatOptions.alignment, formatOptions.positionOffset);
      }
    }
