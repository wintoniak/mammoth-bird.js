...
function Image(options) {
    return {
        ...
        wrappingStyle: options.wrappingStyle,
        alignmentH: options.alignmentH,
        alignmentV: options.alignment,
        positionOffsetH: options.positionOffsetH,
        positionOffsetV: options.positionOffsetV
    };
}
